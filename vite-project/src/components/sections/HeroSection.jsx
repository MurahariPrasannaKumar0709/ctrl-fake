...
const HeroSection = () => {
  ...
  return (
    <>
      <SectionWrapper className="relative min-h-[900px] pb-64 overflow-hidden bg-black">
        ...
        {/* 🔥 SVG ENERGY CIRCUITS - COMPACT VERSION */}
        {/* <div className="absolute inset-0 z-0 w-full h-full pointer-events-none">
          ...
          > */}
            {/* ================= 1. OUTER LEFT CIRCUIT (SMALLER) ================= */}
            {/* <path
              d="M 240 0 L 240 150 Q 240 175, 220 195 L 190 225 Q 170 245, 170 270 L 170 380"
            ...
            {/* ================= 2. INNER LEFT CIRCUIT (SMALLER) ================= */}
            {/* <path
              d="M 340 0 L 340 220 Q 340 250, 360 270 L 400 310"
              stroke="rgba(255, 255, 255, 0.15)"
              strokeWidth="1.2"
            />
            <path
 ...
 */}
            {/* ================= 3. RIGHT TOP CIRCUIT (Slightly Down) ================= */}
            {/* <path
              d="M 1440 160 L 1250 160 Q 1230 160, 1210 180 L 1180 210"
              stroke="rgba(255, 255, 255, 0.15)"
              strokeWidth="1.2"
            />
            <path
 ...
 */}
            {/* ================= 4. RIGHT BOTTOM CIRCUIT (Slightly Down) ================= */}
            {/* <path
              d="M 1440 240 L 1220 240 Q 1200 240, 1180 260 L 1120 320"
              stroke="rgba(255, 255, 255, 0.15)"
              strokeWidth="1.2"
            />
            <path
