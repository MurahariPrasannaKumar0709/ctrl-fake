...
//     <SectionWrapper className="relative px-6 py-24 bg-black translate-y-[-180px]">
//       {/* Main Container Box */}
...
const CTASection = () => {
  return (
    // Outer section background set to light gray per instructions
    // Added md: prefix to your -180px translation so it doesn't overlap on mobile
    <SectionWrapper className="relative px-4 sm:px-6 py-16 md:py-24 bg-black translate-y-[-40px] md:translate-y-[-180px]">
      
      {/* Main Container Box */}
      <div className="relative w-full max-w-[1300px] mx-auto bg-[#0A0A0A] rounded-[32px] border border-white/5 overflow-hidden flex flex-col md:flex-row items-stretch shadow-2xl translate-y-[-20px] md:translate-y-[-60px]">
        
        {/* Left Column: Text & Input */}
        <div className="relative z-10 flex flex-col justify-center w-full p-8 sm:p-12 md:w-[55%] md:p-16 lg:p-20">
          <h2
            className="
              mb-4
              font-['Space_Grotesk',sans-serif]
        ...
        {/* Right Column: Dashboard Mockup Graphic */}
        {/* Adjusted mobile height to fit the scaled mockup perfectly */}
        <div className="relative w-full h-[260px] sm:h-[320px] md:h-auto md:w-[45%] overflow-hidden bg-gradient-to-br from-[#0A0A0A] to-[#111]">
          
          {/* Simulated UI Window */}
          {/* Added scale-[0.55] for mobile, scaling up to scale-100 on desktop. 
              This prevents the 550px width from breaking the layout while keeping internal styles untouched. */}
          <div className="absolute top-8 md:top-16 left-4 md:left-0 w-[550px] h-[400px] bg-[#121212] rounded-2xl md:rounded-tl-2xl border border-[#222] shadow-[0_0_40px_rgba(0,0,0,0.5)] p-5 flex origin-top-left scale-[0.55] sm:scale-[0.70] lg:scale-[0.85] xl:scale-100">
            
            {/* Sidebar Mock - 100% Untouched */}
            <div className="w-[180px] border-r border-[#222] pr-4 flex flex-col gap-6">
              {/* Header */}
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#222] border border-[#333]">
              ...
              {/* Menu */}
              <div className="flex flex-col gap-1">
                <span className="text-[10px] font-bold text-[#555] mb-2 uppercase">Menu</span>
                <div className="flex items-center gap-3 px-2 py-2 text-sm text-[#888] rounded-md">
            ...
            {/* Main Content Mock - 100% Untouched */}
            <div className="relative flex-1 pt-2 pl-6">
              {/* Top Badges */}
              <div className="flex gap-2 mb-10">
                <div className="px-3 py-1.5 text-xs text-[#aaa] bg-[#1a1a1a] border border-[#333] rounded-full flex items-center gap-1">
              ...
              {/* Diagram Node Mock */}
              <div className="relative mt-8 ml-4">
                <svg className="absolute w-32 h-20 -top-10 -left-6" fill="none" stroke="#444" strokeWidth="1.5">
                  <path d="M0 0 Q 20 50 40 50 T 80 50" />
                </svg>
                <div className="relative z-10 w-[180px] p-3 bg-[#111] border border-[#333] rounded-xl flex items-center gap-3 shadow-lg">
                  <div className="absolute -top-2 left-3 w-4 h-4 bg-[#222] border border-[#444] rounded-full flex items-center justify-center text-[10px] text-white">
                  ...
                  <div>
                    <div className="text-sm font-medium text-white">New account</div>
                    <div className="text-xs text-[#666]">Action</div>
                  </div>
                </div>
              </div>
