...
const FeaturesSection = () => {
  ...
  return (
    <SectionWrapper className="relative overflow-hidden bg-black">
      <div className="relative z-10 px-4 py-16 mx-auto md:py-24 max-w-7xl">
        {/* Header */}
        <div className="relative flex flex-col items-start justify-between w-full gap-6 mb-12 md:gap-8 md:mb-16 md:flex-row md:items-end">
          {/* Background Text — Positioned Behind */}
          <div className="absolute -translate-x-1/2 pointer-events-none top-[-20px] md:-top-16 left-1/2">
            <div
              className="
                font-['Oswald']
                text-[100px] sm:text-[140px] md:text-[220px]
                leading-[100px] sm:leading-[140px] md:leading-[220px]
        ...
        {/* Grid Layout - Cards stack on mobile with margin-top, revert to negative margin on large screens */}
        <div className="grid gap-6 mt-8 lg:mt:-mt-8 lg:grid-cols-3 md:gap-4">
          {/* LEFT CARD — Predictive Detection */}
          <div className="relative flex flex-col h-full p-3 border rounded-3xl border-white/30 bg-white/5 backdrop-blur-xl">
            {/* Graph */}
            <div className="relative h-full mb-6 overflow-hidden border md:mb-8 rounded-2xl border-white/20 bg-black/40 min-h-[200px]">
              {/* Grid Lines */}
              <div className="absolute inset-0 opacity-20">
                {[...Array(6)].map((_, i) => (
                  <div
              ...
              {/* Risk Badge */}
              <div className="absolute px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm text-white rounded-xl bg-white/10 backdrop-blur-md top-4 left-4">
                Risk: 30%
              </div>

              {/* High Risk Label */}
              <div
                className="absolute px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm text-white rounded-xl bg-white/10 backdrop-blur-md"
                style={{ top: "38%", left: "46%" }}
              >
                High Risk
              </div>
            ...
            {/* 🔥 Push Content to Bottom */}
            <div className="px-2 mt-auto md:px-0">
              <h3 className="mb-2 text-lg font-semibold text-white md:mb-3">
                Predictive Detection
              </h3>
          ...
          <div className="relative flex flex-col h-full p-3 border rounded-3xl border-white/30 bg-white/5 backdrop-blur-xl">
            {/* Workflow Box */}
            <div className="relative flex items-center justify-center h-full mb-6 border md:mb-8 rounded-2xl border-white/20 bg-black/40">
              <div className="flex flex-col items-center w-full max-w-[320px] py-6 px-4 sm:px-6 md:px-8">
                {/* STEP 1 */}
                <div className="flex items-center w-full gap-3 px-4 py-3 border md:gap-4 md:px-5 rounded-xl border-white/20 bg-white/10 backdrop-blur-md">
                  <div className="flex items-center justify-center w-8 h-8 border rounded-lg md:w-10 md:h-10 border-white/20 bg-black/40 min-w-8">
                    <img
                      src="/detect-threat.png"
                      alt="icon"
                  ...
                  <span className="text-xs text-white sm:text-sm">Detect Threat</span>
                </div>

                {/* Connector */}
                <div className="flex flex-col items-center">
                  <div className="w-[1px] h-4 md:h-6 bg-white/20"></div>
                  <div className="flex items-center justify-center w-6 h-6 text-xs text-white border rounded-full md:w-8 md:h-8 md:text-sm border-white/20 bg-black/60">
                    +
                  </div>
                  <div className="w-[1px] h-4 md:h-6 bg-white/20"></div>
                </div>
                ...
                <div className="flex items-center w-full gap-3 px-4 py-3 border md:gap-4 md:px-5 rounded-xl border-white/20 bg-white/10 backdrop-blur-md">
                  ...
                  <span className="text-xs text-white sm:text-sm">Automated Action</span>
                </div>
                ...
                <div className="flex items-center w-full gap-3 px-4 py-3 border md:gap-4 md:px-5 rounded-xl border-white/20 bg-white/10 backdrop-blur-md">
                  <div className="flex items-center justify-center w-8 h-8 border rounded-lg md:w-10 md:h-10 border-white/20 bg-black/40 min-w-8">
                    <img src="/notify.png" alt="icon" className="w-4 h-4 md:w-5 md:h-5" />
                  </div>
                  <span className="text-xs text-white sm:text-sm">Notify</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            <div className="flex flex-col overflow-hidden border rounded-3xl border-white/30 bg-white/5 backdrop-blur-xl">
              {/* Full-bleed Image Container */}
              <div className="relative flex items-center justify-center w-full h-48 overflow-hidden border-b sm:h-56 md:h-64 bg-black/20 border-white/5">
                <svg
                  className="absolute inset-0 w-full h-full"
                  viewBox="0 0 400 200"
                  fill="none"
            ...
            {/* Bottom Right Card */}
            <div className="p-5 border sm:p-6 md:p-4 rounded-3xl border-white/30 bg-white/5 backdrop-blur-xl">
              <h3 className="mb-2 text-lg font-semibold text-white md:mb-3">
                Natural Language Processing
              </h3>
              <p className="text-sm text-gray-400">
