...
const FAQSection = () => {
  ...
  return (
    // Added -translate-y-[60px] for mobile and -translate-y-[120px] for md screens
    <SectionWrapper className="relative py-12 lg:py-20 overflow-hidden -translate-y-[60px] md:-translate-y-[120px] lg:-translate-y-[280px] bg-black">
      {/* Content Container - Full Width */}
      <div className="relative z-10 flex flex-col items-start w-full gap-10 px-4 sm:px-6 lg:px-10 lg:flex-row lg:gap-32 md:pt-20">
        ...
        <div className="flex flex-col w-full lg:w-2/3">
          ...
          <div className="w-full border-b border-white/10">
            <button
              onClick={() => setOpenIndex(openIndex === 0 ? null : 0)}
              className="flex items-center justify-between w-full py-5 text-left group lg:py-6"
            >
              <span className="text-[16px] lg:text-[17px] font-medium text-white/90 group-hover:text-white transition-colors pr-4">
                What is CtrlFake and how does it work?
              </span>
              <span
                className={`text-xl text-white/70 shrink-0 transition-transform duration-300 ${
                  openIndex === 0 ? "rotate-45" : ""
                }`}
              >
                +
            ...
            {openIndex === 0 && (
              <div className="pb-5 pr-4 lg:pb-6 lg:pr-8">
