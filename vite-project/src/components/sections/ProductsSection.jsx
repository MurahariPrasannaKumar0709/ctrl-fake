...
//                 Deepfake videos are rapidly growing. CtrlFake detects
//                 AI-generated content with 85% accuracy, ensuring video
//                 authenticity and stronger digital trust.
//               </p>
...
const ProductsSection = () => {
  return (
    <SectionWrapper className="relative py-16 overflow-hidden bg-black md:py-28">
      {/* Background Text — Perfectly Centered */}
      <div className="flex items-center justify-center pointer-events-none opacity-[0.12] select-none translate-y-0">
        <div
          className="
            font-['Oswald']
            text-[80px] sm:text-[120px] md:text-[220px]
            leading-[80px] sm:leading-[120px] md:leading-[220px]
      ...
      <div className="relative z-10 px-4 mx-auto max-w-7xl">
        ...
        <div className="mb-12 md:mb-20">
          {/* Main Heading + Description (Split Layout) */}
          <div className="grid items-center grid-cols-1 gap-6 md:gap-10 md:grid-cols-2 mt-8 md:mt-0 translate-y-0 md:-translate-y-[120px]">
            {/* LEFT SIDE - Heading */}
            <h2
              className="
                  font-['Space_Grotesk',sans-serif]
        ...
        {/* Products Grid - Added items-stretch for equal heights */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch translate-y-0 md:-translate-y-[160px]">
          
          {/* 1️⃣ Image Detection - Premium Layout */}
          <div className="relative flex flex-col h-full p-6 overflow-hidden border sm:p-10 rounded-3xl border-white/10 bg-gradient-to-br from-zinc-900 via-black to-black backdrop-blur-xl">
            {/* Soft Gradient Glow */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_0%,rgba(59,130,246,0.15),transparent_60%)] pointer-events-none"></div>

            {/* Content Container - flex-1 pushes visual to bottom */}
            <div className="relative flex flex-col flex-1 h-full">
              ...
              {/* Buttons */}
              <div className="flex flex-col gap-3 mb-8 sm:flex-row sm:gap-4 sm:mb-12">
                <Button
                  variant="dark"
                  size="sm"
                  className="w-full px-6 py-3 transition border sm:w-auto sm:py-2 border-white/20 rounded-xl hover:border-white/40"
                >
                  AI GENERATED →
                </Button>
              ...
              {/* Premium Visual Section - mt-auto pushes it to the bottom */}
              <div className="relative mt-auto shrink-0 flex items-center justify-center overflow-hidden border h-64 sm:h-72 w-full rounded-3xl border-white/10 bg-[#111] shadow-inner">
                {/* Scaler wrapper for mobile */}
                <div className="absolute inset-0 flex items-center justify-center scale-[0.75] md:scale-90 lg:scale-100">
                  {/* Scanner Corner Brackets */}
                  <div className="absolute top-8 left-8 w-10 h-10 border-t-[3px] border-l-[3px] border-[#555]"></div>
                  <div className="absolute top-8 right-8 w-10 h-10 border-t-[3px] border-r-[3px] border-[#555]"></div>
                  <div className="absolute bottom-16 left-8 w-10 h-10 border-b-[3px] border-l-[3px] border-[#555]"></div>
                  ...
                  <div className="relative flex items-center justify-center w-[300px] h-[200px] -mt-6">
                    ...
                    <svg
                      ...
                      viewBox="0 0 300 300"
                    >
                      <g stroke="#555" strokeWidth="1.5" fill="none" strokeLinejoin="round">
                        <path d="M150,30 L120,40 L95,65 L80,100 L70,140 L75,180 L95,220 L125,245 L150,255 L175,245 L205,220 L225,180 L230,140 L220,100 L205,65 L180,40 Z M150,30 L150,75 L120,40 M150,30 L180,40 M150,75 L125,105 M150,75 L175,105 M150,75 L95,65 M150,75 L205,65 M125,105 L110,120 L135,120 Z M175,105 L190,120 L165,120 Z M150,120 L135,120 M150,120 L165,120 M150,120 L150,165 M135,120 L135,155 L150,165 L165,155 L165,120 M150,165 L150,195 M135,155 L110,140 L110,120 M165,155 L190,140 L190,120 M110,140 L80,100 M190,140 L220,100 M110,140 L70,140 M190,140 L230,140 M135,155 L100,165 L75,180 M165,155 L200,165 L225,180 M100,165 L95,220 M200,165 L205,220 M150,195 L130,195 L115,190 L100,165 M150,195 L170,195 L185,190 L200,165 M130,195 L125,245 M170,195 L175,245 M150,195 L150,215 L125,220 L115,190 M150,215 L175,220 L185,190 M150,215 L150,255 M125,245 L150,215 M175,245 L150,215" />
                      </g>
                      <g fill="#777">
                        {[[150, 30], [120, 40], [95, 65], [80, 100], [70, 140], [75, 180], [95, 220], [125, 245], [150, 255], [175, 245], [205, 220], [225, 180], [230, 140], [220, 100], [205, 65], [180, 40], [150, 75], [125, 105], [175, 105], [110, 120], [135, 120], [190, 120], [165, 120], [150, 120], [150, 165], [135, 155], [165, 155], [110, 140], [190, 140], [100, 165], [200, 165], [150, 195], [130, 195], [115, 190], [170, 195], [185, 190], [150, 215], [125, 220], [175, 220]].map((point, i) => (
                          <circle key={i} cx={point[0]} cy={point[1]} r="2.5" />
                        ))}
                      </g>
                    </svg>
                  ...
                  <div className="absolute bottom-5 flex gap-[3px] opacity-70">
                    {[...Array(7)].map((_, i) => (
                      <div key={i} className={`w-[7px] h-[10px] bg-[#${['222','444','666','555','333','222','222'][i]}]`}></div>
                    ))}
                  </div>
                </div>
              </div>
          ...
          <div className="relative flex flex-col h-full p-6 overflow-hidden border sm:p-10 rounded-3xl border-white/10 bg-gradient-to-br from-zinc-900 via-black to-black backdrop-blur-xl">
            ...
            <div className="relative flex flex-col flex-1 h-full">
              ...
              {/* Premium Visual Section: Camera Viewfinder */}
              <div className="relative mt-auto shrink-0 flex items-center justify-center overflow-hidden border h-64 sm:h-72 w-full rounded-3xl border-white/10 bg-[#141414] shadow-inner font-mono select-none">
                <div className="absolute inset-0 flex items-center justify-center scale-[0.75] md:scale-90 lg:scale-100">
                  {/* --- Outer Viewfinder Frame Brackets --- */}
                  <div className="absolute top-6 left-6 w-12 h-12 border-t border-l border-[#555]"></div>
                  <div className="absolute top-6 right-6 w-12 h-12 border-t border-r border-[#555]"></div>
                  ...
                  <div className="absolute flex flex-col items-end top-8 right-10 gap-1.5 text-[11px] text-[#bbb]">
                    <div className="flex items-center gap-2">
                      <span className="tracking-widest">00:16:08:02</span>
                      <div className="w-2.5 h-2.5 bg-red-600 rounded-full animate-pulse shadow-[0_0_8px_rgba(220,38,38,0.8)]"></div>
                      <span className="font-sans font-bold tracking-widest text-white">REC</span>
                    </div>
                    <div className="bg-[#ccc] text-[#111] font-sans font-bold px-1.5 py-[1px] text-[10px] rounded-sm mt-0.5">
                      4K
                    </div>
                  ...
                  <div className="absolute bottom-8 flex flex-col items-center gap-2 w-full text-[11px] text-[#bbb]">
                    <div className="flex items-center gap-1.5 tracking-[0.2em] font-sans">
                      <span>-</span><span>3</span><span className="text-[8px]">●</span><span>2</span><span className="text-[8px]">●</span><span>1</span><span className="text-[8px]">●</span>
                      <div className="relative flex flex-col items-center">
                        <span className="font-bold text-white">0</span>
                        <div className="absolute -bottom-1.5 w-0 h-0 border-l-[3.5px] border-r-[3.5px] border-b-[5px] border-transparent border-b-[#888]"></div>
                      </div>
                      <span className="text-[8px]">●</span><span>1</span><span className="text-[8px]">●</span><span>2</span><span className="text-[8px]">●</span><span>3</span><span>+</span>
                    </div>
                    <div className="flex items-center gap-6 mt-1 tracking-widest">
                      <span>F/1.8</span>
                      <span className="flex items-start">
                        <span className="text-[7px] mt-0.5 mr-0.5 font-sans tracking-normal">ISO</span>600
                      </span>
                      <span>4/100</span>
                    </div>
                  </div>
          ...
          <div className="relative flex flex-col h-full p-6 overflow-hidden border sm:p-10 rounded-3xl border-white/10 bg-gradient-to-br from-zinc-900 via-black to-black backdrop-blur-xl">
            ...
            <div className="relative flex flex-col flex-1 h-full">
              ...
              {/* Premium Visual Section */}
              <div className="relative flex items-center justify-center w-full h-64 mt-auto overflow-hidden border shrink-0 sm:h-72 rounded-3xl border-white/10 bg-gradient-to-br from-black via-zinc-900 to-black">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent translate-x-[-100%] animate-[sweep_6s_linear_infinite] pointer-events-none"></div>
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.06),transparent_70%)] pointer-events-none"></div>

                {/* Premium Waveform - Flex-wrap handled or shrunk to fit mobile safely */}
                <div className="relative flex items-center justify-center gap-1 sm:gap-[6px] h-40 w-full px-2 overflow-hidden">
                  {[...Array(70)].map((_, i) => {
                    const center = 35;
                    const distanceFromCenter = Math.abs(center - i);
                    const baseHeight = 25 + Math.max(0, 60 - distanceFromCenter * 2) + Math.random() * 30;

                    return (
                      <div
                        key={i}
                        className="w-[2px] sm:w-[3px] shrink-0 rounded-full bg-white/35 animate-[wave_2s_ease-in-out_infinite]"
                        style={{
                          height: `${baseHeight}px`,
                          animationDelay: `${i * 0.01}s`,
                        }}
                ...
                <div className="absolute text-[10px] sm:text-xs tracking-widest text-gray-500 bottom-6">
                  VOICE ANALYSIS
                </div>
              </div>
            </div>
          ...
          <div className="relative flex flex-col h-full p-6 overflow-hidden border sm:p-10 rounded-3xl border-white/10 bg-gradient-to-br from-zinc-900 via-black to-black backdrop-blur-xl">
            ...
            <div className="relative flex flex-col flex-1 h-full">
              ...
              {/* Premium Visual Section */}
              <div className="relative flex items-center justify-center w-full h-64 mt-auto overflow-hidden border shrink-0 sm:h-72 rounded-3xl border-white/10 bg-gradient-to-br from-black via-zinc-900 to-black animate-floatSlow">
                <div className="absolute inset-0 flex items-center justify-center scale-[0.65] md:scale-90 lg:scale-100 w-full h-full">
                  <div className="absolute inset-0 pointer-events-none bg-gradient-to-r from-transparent via-white/5 to-transparent animate-sweep"></div>
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.05),transparent_70%)] pointer-events-none"></div>

                  {/* LEFT CONNECTION LINES */}
                  <div className="absolute left-6 sm:left-16 top-1/2 w-16 sm:w-24 h-[1px] bg-white/10 -translate-y-1/2"></div>
                  <div className="absolute left-6 sm:left-16 top-[45%] w-10 sm:w-16 h-[1px] bg-white/5 rotate-6 origin-left"></div>
                  <div className="absolute left-6 sm:left-16 top-[55%] w-10 sm:w-16 h-[1px] bg-white/5 -rotate-6 origin-left"></div>
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="relative flex items-center justify-center w-28 h-28 rounded-full border border-white/20 bg-black shadow-[0_0_20px_rgba(255,255,255,0.05)]">
                      <svg className="w-6 h-6 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3v2m0 14v2m9-9h-2M5 12H3m15.364 6.364l-1.414-1.414M7.05 7.05 5.636 5.636m12.728 0-1.414 1.414M7.05 16.95l-1.414 1.414M12 8a4 4 0 100 8 4 4 0 000-8z" />
                      </svg>
                    </div>
                  </div>

                  {/* RIGHT CONNECTION LINE */}
                  <div className="absolute right-24 sm:right-28 top-1/2 w-12 sm:w-20 h-[1px] bg-white/10 -translate-y-1/2 animate-fadeLine"></div>
                  <div className="absolute w-2 h-2 -translate-y-1/2 rounded-full right-24 sm:right-28 top-1/2 bg-white/20"></div>

                  {/* RIGHT GLASS CARD */}
                  <div className="absolute right-4 sm:right-12 flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-[26px] border border-white/10 bg-white/[0.05] backdrop-blur-2xl shadow-[0_0_50px_rgba(255,255,255,0.05)] animate-floatSlow">
                    <div className="absolute inset-0 rounded-[26px] bg-gradient-to-br from-white/10 via-transparent to-transparent opacity-40 pointer-events-none"></div>
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white/70" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M12 22V14a4 4 0 014-4h8" />
                      <path d="M44 10h8a4 4 0 014 4v8" />
                      <path d="M12 42v8a4 4 0 004 4h8" />
                      <path d="M44 54h8a4 4 0 004-4v-8" />
                      <circle cx="32" cy="26" r="6" fill="currentColor" stroke="none" />
                      <path d="M20 48c4-8 20-8 24 0" />
                    </svg>
                  </div>

                  {/* LABEL */}
                  <div className="absolute bottom-4 sm:bottom-2 text-[10px] sm:text-[11px] tracking-[0.25em] text-gray-500">
                    FACT VERIFICATION
                  </div>
                </div>
              </div>
